...
This is deliberately a question about **measurement**, not about waste. Phase 0 established that waste data is not publicly retrievable, so the honest deliverable is a dependable reconstruction of what *is* measured, plus a precise statement of what is not.
...
Class 4 framing: **Problem → Information need → Field → Source → Owner → Freshness → Trust → Gap.** "Relevant does not mean authoritative."

| # | Information need | Field / event | Source | Owner | Freshness | Trust (Phase 2) | Gap |
|---|---|---|---|---|---|---|---|
